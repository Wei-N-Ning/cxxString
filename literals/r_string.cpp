...
// NOTE:
// I can exploit C++11 raw string literal to store a
// med-sized text file in the binary
...
// this can come from a different compilation unit, module or library
namespace resource {

namespace {

const char* text = R"IDDQDIDKFA(# --
import os
import re
try:
